#!/usr/bin/env python3
"""
Simplified accuracy test that skips NER processing to focus on scoring accuracy
"""
import sys
import os
...
class SimpleAccuracyTester:
    ...
    def get_job_description(self, job_role):
        ...
        if hasattr(self, 'job_descriptions') and job_role in self.job_descriptions:
            ...
            # Check if jd_data is a dictionary
    ...
    def calculate_score(self, resume_text, job_role):
        """Calculate score using raw text only (no parsing)"""
        try:
    ...
    def run_predictions(self):
        ...
        print("🔍 Running predictions using ResumeScorer...")
        self.predictions = []
        self.actual_scores = []
        ...
        for i, sample in enumerate(self.data):
            ...
            try:
                predicted_score = self.calculate_score(
                    sample['resume_text'], 
                    sample['job_role']
                )
    ...
    def create_visualizations(self):
        ...
        plt.tight_layout()
        plt.savefig('simple_performance_analysis.png', dpi=300, bbox_inches='tight')
        print("✅ Visualizations saved to simple_performance_analysis.png")
        plt.show()
    
    def save_detailed_results(self, output_path="simple_detailed_results.csv"):
    ...
    def run_complete_test(self):
        ...
        print("🚀 Starting AI Resume Evaluator Accuracy Test (Simplified)")
        print("="*60)
